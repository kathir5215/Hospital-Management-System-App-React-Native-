...
const ListPatients = () => {
  ...
  useEffect(() => {
    const fetchPatients = async () => {
      try {
        const response = await api.get('/Papi/patient');
      ...
      <View style={styles.actions}>
        {(role === 'SUPER_ADMIN' || role === 'ADMIN') && (
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('EditPatient', { id: item.id })}
          >
        ...
        {role === 'SUPER_ADMIN' && (
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('DeletePatient', { id: item.id })
            }
          >
